...
func (a *App) printHelp() {
	...
	a.printHelpSection(ui, helpSection{
		...
		rows: [][]string{
			...
			{"szr self doctor [--json] [--refresh]", "Check PATH, config, cache, version, and optional tools."},
			...
			{"szr install codex --global", "Enable szr guidance for Codex in every repository."},
			{"szr install codex --root <path>", "Enable szr guidance for one explicit repository."},
	...
	a.printHelpSection(ui, helpSection{
		...
		rows: [][]string{
			...
			{"szr diagnostics flush", "Explicitly attempt one bounded diagnostics export."},
...
func (a *App) printCommands() {
	...
	a.printHelpSection(ui, helpSection{
		...
		rows: [][]string{
			...
			{"szr watch --jsonl [--once]", "Stream sanitized live execution metrics; see docs/INTEGRATIONS.md."},
		},
	})
	a.printHelpSection(ui, helpSection{
		title: "Local Tools:",
	...
	a.printHelpSection(ui, helpSection{
		...
		rows: [][]string{
			...
			{"szr self doctor [--json] [--refresh]", "Inspect the global install target and PATH state; --refresh forces a live release check."},
			{"szr install codex", "Patch AGENTS.md at the detected Git root."},
			{"szr install codex --global", "Patch $CODEX_HOME/AGENTS.md for every repository."},
			{"szr install codex --root <path>", "Patch AGENTS.md in one explicit repository."},
			...
			{"szr uninstall codex [--global|--root <path>]", "Remove the matching Codex AGENTS.md patch."},
